 ...
 * @generated
 */
public class CrearInstanciaNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CrearInstanciaNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.CrearInstancia_2004, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.CrearInstanciaNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
