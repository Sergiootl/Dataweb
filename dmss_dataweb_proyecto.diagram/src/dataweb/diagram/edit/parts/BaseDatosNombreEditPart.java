...
public class BaseDatosNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.BaseDatos_2015, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.BaseDatosNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
