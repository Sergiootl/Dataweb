 ...
 * @generated
 */
public class ContenidoMultimediaTipoEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ContenidoMultimediaTipoEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.ContenidoMultimedia_3004, getParserElement(),
					DatawebVisualIDRegistry
							.getType(dataweb.diagram.edit.parts.ContenidoMultimediaTipoEditPart.VISUAL_ID));
		}
		return parser;
	}
