 ...
 * @generated
 */
public class PreguntaTexto2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PreguntaTexto2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.Pregunta_3003, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.PreguntaTexto2EditPart.VISUAL_ID));
		}
		return parser;
	}
