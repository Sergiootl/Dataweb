 ...
 * @generated
 */
public class IndiceEntidadNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IndiceEntidadNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.IndiceEntidad_2002, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.IndiceEntidadNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
