 ...
 * @generated
 */
public class BorradoInstanciaNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BorradoInstanciaNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.BorradoInstancia_2007, getParserElement(),
					DatawebVisualIDRegistry
							.getType(dataweb.diagram.edit.parts.BorradoInstanciaNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
