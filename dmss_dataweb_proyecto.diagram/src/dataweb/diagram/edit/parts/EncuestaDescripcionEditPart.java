...
public class EncuestaDescripcionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.Encuesta_2009, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.EncuestaDescripcionEditPart.VISUAL_ID));
		}
		return parser;
	}
