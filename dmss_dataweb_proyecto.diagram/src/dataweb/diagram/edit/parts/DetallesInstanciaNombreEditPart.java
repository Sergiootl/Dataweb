 ...
 * @generated
 */
public class DetallesInstanciaNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DetallesInstanciaNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.DetallesInstancia_2005, getParserElement(),
					DatawebVisualIDRegistry
							.getType(dataweb.diagram.edit.parts.DetallesInstanciaNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
