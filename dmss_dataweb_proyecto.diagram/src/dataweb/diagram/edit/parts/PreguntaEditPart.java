...
import dataweb.diagram.edit.policies.PreguntaItemSemanticEditPolicy;
...
public class PreguntaEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PreguntaItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PreguntaTextoEditPart) {
			((PreguntaTextoEditPart) childEditPart).setLabel(getPrimaryShape().getFigurePreguntaLabelFigure());
			return true;
		}
		if (childEditPart instanceof PreguntaPreguntaRespuestasCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getPreguntaRespuestasCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PreguntaPreguntaRespuestasCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PreguntaPreguntaRespuestasCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getPreguntaRespuestasCompartmentFigure();
			pane.remove(((PreguntaPreguntaRespuestasCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PreguntaPreguntaRespuestasCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DatawebVisualIDRegistry.getType(PreguntaTextoEditPart.VISUAL_ID));
	}
