 ...
 * @generated
 */
public class IndiceExtendidoNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IndiceExtendidoNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.IndiceExtendido_2001, getParserElement(),
					DatawebVisualIDRegistry
							.getType(dataweb.diagram.edit.parts.IndiceExtendidoNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
