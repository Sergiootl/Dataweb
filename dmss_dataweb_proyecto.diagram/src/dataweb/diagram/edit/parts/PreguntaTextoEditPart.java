...
public class PreguntaTextoEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.Pregunta_3001, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.PreguntaTextoEditPart.VISUAL_ID));
		}
		return parser;
	}
