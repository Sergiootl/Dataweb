 ...
 * @generated
 */
public class NormalContenidoEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public NormalContenidoEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.Normal_2011, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.NormalContenidoEditPart.VISUAL_ID));
		}
		return parser;
	}
