...
public class RespuestaTextoEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.Respuesta_3002, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.RespuestaTextoEditPart.VISUAL_ID));
		}
		return parser;
	}
