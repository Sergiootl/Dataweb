 ...
 * @generated
 */
public class CRUDNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CRUDNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.CRUD_2010, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.CRUDNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
