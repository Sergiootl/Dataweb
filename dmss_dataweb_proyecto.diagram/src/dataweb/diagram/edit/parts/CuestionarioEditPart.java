...
public class CuestionarioEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CuestionarioCuestionarioPreguntasCCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getCuestionarioPreguntasCCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((CuestionarioCuestionarioPreguntasCCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CuestionarioCuestionarioPreguntasCCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getCuestionarioPreguntasCCompartmentFigure();
			pane.remove(((CuestionarioCuestionarioPreguntasCCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof CuestionarioCuestionarioPreguntasCCompartmentEditPart) {
			return getPrimaryShape().getCuestionarioPreguntasCCompartmentFigure();
		}
	...
	*/
	...
	public class CuestionarioFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private RectangleFigure fCuestionarioPreguntasCCompartmentFigure;
		...
		private void createContents() {
			...
			fCuestionarioPreguntasCCompartmentFigure = new RectangleFigure();

			fCuestionarioPreguntasCCompartmentFigure.setOutline(false);

			this.add(fCuestionarioPreguntasCCompartmentFigure);
		 ...
		 * @generated
		 */
		public RectangleFigure getCuestionarioPreguntasCCompartmentFigure() {
			return fCuestionarioPreguntasCCompartmentFigure;
		}
