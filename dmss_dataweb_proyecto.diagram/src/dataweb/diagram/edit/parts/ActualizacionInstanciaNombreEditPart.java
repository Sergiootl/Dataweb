 ...
 * @generated
 */
public class ActualizacionInstanciaNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ActualizacionInstanciaNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.ActualizacionInstancia_2006,
					getParserElement(), DatawebVisualIDRegistry
							.getType(dataweb.diagram.edit.parts.ActualizacionInstanciaNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
