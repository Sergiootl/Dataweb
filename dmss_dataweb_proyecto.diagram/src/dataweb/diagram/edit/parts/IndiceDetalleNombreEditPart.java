 ...
 * @generated
 */
public class IndiceDetalleNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IndiceDetalleNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.IndiceDetalle_2003, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.IndiceDetalleNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
