 ...
 * @generated
 */
public class IndexNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IndexNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.Index_2012, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.IndexNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
