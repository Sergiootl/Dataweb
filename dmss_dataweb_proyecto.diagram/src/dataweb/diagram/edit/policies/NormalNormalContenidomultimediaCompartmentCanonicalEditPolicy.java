 ...
 * @generated
 */
public class NormalNormalContenidomultimediaCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DatawebPackage.eINSTANCE.getNormal_Contenidomultimedia();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DatawebNodeDescriptor> childDescriptors = DatawebDiagramUpdater
				.getNormalNormalContenidomultimediaCompartment_7005SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ContenidoMultimediaEditPart.VISUAL_ID == DatawebVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DatawebNodeDescriptor> childDescriptors = DatawebDiagramUpdater
				.getNormalNormalContenidomultimediaCompartment_7005SemanticChildren((View) getHost().getModel());
