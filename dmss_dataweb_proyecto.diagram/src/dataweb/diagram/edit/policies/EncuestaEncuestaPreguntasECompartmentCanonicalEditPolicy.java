 ...
 * @generated
 */
public class EncuestaEncuestaPreguntasECompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DatawebPackage.eINSTANCE.getEncuesta_PreguntasE();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DatawebNodeDescriptor> childDescriptors = DatawebDiagramUpdater
				.getEncuestaEncuestaPreguntasECompartment_7003SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return Pregunta2EditPart.VISUAL_ID == DatawebVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DatawebNodeDescriptor> childDescriptors = DatawebDiagramUpdater
				.getEncuestaEncuestaPreguntasECompartment_7003SemanticChildren((View) getHost().getModel());
