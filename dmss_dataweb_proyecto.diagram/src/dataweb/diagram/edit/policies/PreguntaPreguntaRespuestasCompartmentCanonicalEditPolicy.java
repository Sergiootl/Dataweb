...
public class PreguntaPreguntaRespuestasCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DatawebNodeDescriptor> childDescriptors = DatawebDiagramUpdater
				.getPreguntaPreguntaRespuestasCompartment_7002SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DatawebNodeDescriptor> childDescriptors = DatawebDiagramUpdater
				.getPreguntaPreguntaRespuestasCompartment_7002SemanticChildren((View) getHost().getModel());
