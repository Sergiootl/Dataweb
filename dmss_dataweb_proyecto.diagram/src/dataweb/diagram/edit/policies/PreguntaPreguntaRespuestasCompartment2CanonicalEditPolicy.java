 ...
 * @generated
 */
public class PreguntaPreguntaRespuestasCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DatawebPackage.eINSTANCE.getPregunta_Respuestas();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DatawebNodeDescriptor> childDescriptors = DatawebDiagramUpdater
				.getPreguntaPreguntaRespuestasCompartment_7004SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return RespuestaEditPart.VISUAL_ID == DatawebVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DatawebNodeDescriptor> childDescriptors = DatawebDiagramUpdater
				.getPreguntaPreguntaRespuestasCompartment_7004SemanticChildren((View) getHost().getModel());
