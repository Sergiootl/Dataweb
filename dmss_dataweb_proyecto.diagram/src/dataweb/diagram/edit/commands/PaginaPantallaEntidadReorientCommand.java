 ...
 * @generated
 */
public class PaginaPantallaEntidadReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public PaginaPantallaEntidadReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Entidad && newEnd instanceof PaginaPantalla)) {
			return false;
		}
		return DatawebBaseItemSemanticEditPolicy.getLinkConstraints().canExistPaginaPantallaEntidad_4009(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return DatawebBaseItemSemanticEditPolicy.getLinkConstraints().canExistPaginaPantallaEntidad_4009(getOldSource(),
				getNewTarget());
	}
