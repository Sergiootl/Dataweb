...
public class AtributoItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addTipoAtributoPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Tipo Atributo feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTipoAtributoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Atributo_TipoAtributo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Atributo_TipoAtributo_feature", "_UI_Atributo_type"),
				 DatawebPackage.Literals.ATRIBUTO__TIPO_ATRIBUTO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPrimaryKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Atributo_PrimaryKey_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Atributo_PrimaryKey_feature", "_UI_Atributo_type"),
				 DatawebPackage.Literals.ATRIBUTO__PRIMARY_KEY,
				 true,
				 false,
				 false,
