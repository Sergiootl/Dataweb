...
/**
 * This is the item provider adapter for a {@link dataweb.Encuesta} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EncuestaItemProvider extends InteractivaItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Encuesta_numeroPregVF_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Encuesta_numeroPregVF_feature", "_UI_Encuesta_type"),
				 DatawebPackage.Literals.ENCUESTA__NUMERO_PREG_VF,
				 true,
				 false,
				 false,
	...
	protected void addNumeroPregSelectPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Encuesta_numeroPregSelect_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Encuesta_numeroPregSelect_feature", "_UI_Encuesta_type"),
				 DatawebPackage.Literals.ENCUESTA__NUMERO_PREG_SELECT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DatawebPackage.Literals.ENCUESTA__PREGUNTAS_E);
		}
	...
	public String getText(Object object) {
		String label = ((Encuesta)object).getNombre();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DatawebPackage.Literals.ENCUESTA__PREGUNTAS_E,
