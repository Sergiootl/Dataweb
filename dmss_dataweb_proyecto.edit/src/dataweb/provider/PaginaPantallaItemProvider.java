	...
	protected void addEntidadPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PaginaPantalla_entidad_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PaginaPantalla_entidad_feature", "_UI_PaginaPantalla_type"),
				 DatawebPackage.Literals.PAGINA_PANTALLA__ENTIDAD,
				 true,
				 false,
				 true,
				 null,
