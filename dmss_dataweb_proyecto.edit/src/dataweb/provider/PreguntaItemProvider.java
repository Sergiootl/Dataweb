...
public class PreguntaItemProvider 
	...
	protected void addRcorrectaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Pregunta_Rcorrecta_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Pregunta_Rcorrecta_feature", "_UI_Pregunta_type"),
				 DatawebPackage.Literals.PREGUNTA__RCORRECTA,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		TipoPregunta labelValue = ((Pregunta)object).getTipo();
